...
/**
 * A version of DragPictureDemo that creates an Edit menu with cut/copy/paste actions. This demo adds a class called TransferActionDemo that transfers the
