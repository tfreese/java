...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HazelcastJavaConfigNode1.class);
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        ForkJoinPool.commonPool().execute(() ->
        {
            while (true)
            {
                ...
                LOGGER.info("HazelcastJavaConfigNode1: {}: cache value = {}", Thread.currentThread().getName(), value);
