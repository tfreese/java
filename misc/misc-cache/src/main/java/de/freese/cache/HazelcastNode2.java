...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HazelcastNode2.class);
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        ForkJoinPool.commonPool().execute(() ->
        {
            while (true)
            {
                ...
                LOGGER.info("HazelcastNode2:{}: cache value = {}", Thread.currentThread().getName(), value);
