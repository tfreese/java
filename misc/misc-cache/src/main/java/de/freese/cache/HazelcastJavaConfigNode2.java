...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HazelcastJavaConfigNode2.class);
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        ForkJoinPool.commonPool().execute(() ->
        {
            while (true)
            {
                ...
                LOGGER.info("HazelcastJavaConfigNode2: {}: cache value = {}", Thread.currentThread().getName(), value);
