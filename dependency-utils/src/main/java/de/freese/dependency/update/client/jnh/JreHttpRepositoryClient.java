 ...
 */
final class JreHttpRepositoryClient extends AbstractRetryableRepositoryClient {
    private final HttpClient httpClient;

    JreHttpRepositoryClient(final int maxRetries, final Duration retryInterval, final HttpClient httpClient) {
